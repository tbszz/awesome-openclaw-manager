...
Copy-Item -Force (Join-Path $repoRoot "docs\\releases\\windows-local.en.md") (Join-Path $localDir "README.md")
Copy-Item -Force (Join-Path $repoRoot "docs\\releases\\windows-local.md") (Join-Path $localDir "README.zh-CN.md")
Copy-Item -Force (Join-Path $repoRoot "docs\\releases\\windows-wsl2.en.md") (Join-Path $wslDir "README.md")
Copy-Item -Force (Join-Path $repoRoot "docs\\releases\\windows-wsl2.md") (Join-Path $wslDir "README.zh-CN.md")
...
Copy-Item -Force (Join-Path $repoRoot "docs\\screenshots\\manager-ui-en.png") (Join-Path $localDir "manager-ui-en.png")
Copy-Item -Force (Join-Path $repoRoot "docs\\screenshots\\manager-ui-en.png") (Join-Path $wslDir "manager-ui-en.png")
